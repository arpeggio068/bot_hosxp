...
; Credits .....: @mylise
; ===============================================================================================================================
Func _MatchPicture($handle, $Match_Pic, $Left, $Top, $Right, $bottom, $Threshold = 0.75)
	...
	$Coordinates[4] = ($Coordinates[0] + $Coordinates[2]) / 2 ;x+x2/2 จุดกลางภาพ
	$Coordinates[5] = ($Coordinates[1] + $Coordinates[3]) / 2 ;y+y2/2 จุดกลางภาพ
